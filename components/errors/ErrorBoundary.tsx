        ...
        <div className="flex flex-col gap-4 rounded-lg border border-error-200 dark:border-error-800 bg-error-50 dark:bg-error-900/30 p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-1 flex-col gap-1">
              <h3 className="text-sm font-semibold text-error-800 dark:text-error-100">
                오류가 발생했습니다
              </h3>
              ...
              {isDevelopment && error && (
                <details className="flex flex-col gap-2">
                  <summary className="cursor-pointer text-xs text-error-600 dark:text-error-400 hover:text-error-800 dark:hover:text-error-200">
                    개발자 정보 (개발 모드에서만 표시)
                  </summary>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="rounded-lg bg-error-600 px-4 py-2 text-sm font-medium text-white transition-base hover:bg-error-700 focus:outline-none focus:ring-2 focus:ring-error-500 focus:ring-offset-2"
                >
                  다시 시도
                </button>
                <button
                  onClick={() => window.location.reload()}
                  className="rounded-lg border border-error-300 dark:border-error-700 bg-white dark:bg-secondary-900 px-4 py-2 text-sm font-medium text-error-700 dark:text-error-300 transition-base hover:bg-error-50 dark:hover:bg-error-900/20 focus:outline-none focus:ring-2 focus:ring-error-500 focus:ring-offset-2"
                >
                  페이지 새로고침
                </button>
              </div>
