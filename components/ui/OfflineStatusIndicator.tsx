...
const statusConfig = {
  offline: {
    ...
    bgClass: "bg-[rgb(var(--color-warning-100))]",
    textClass: "text-[rgb(var(--color-warning-800))]",
    borderClass: "border-[rgb(var(--color-warning-300))]",
    iconClass: "text-[rgb(var(--color-warning-600))]",
  },
  syncing: {
    icon: RefreshCw,
    label: "동기화 중",
    ...
    bgClass: "bg-[rgb(var(--color-info-100))]",
    textClass: "text-[rgb(var(--color-info-800))]",
    borderClass: "border-[rgb(var(--color-info-300))]",
    iconClass: "text-[rgb(var(--color-info-600))]",
  },
  pending: {
    icon: CloudOff,
    label: "동기화 대기",
  ...
  synced: {
    ...
    bgClass: "bg-[rgb(var(--color-success-100))]",
    textClass: "text-[rgb(var(--color-success-800))]",
    borderClass: "border-[rgb(var(--color-success-300))]",
    iconClass: "text-[rgb(var(--color-success-600))]",
  },
};
