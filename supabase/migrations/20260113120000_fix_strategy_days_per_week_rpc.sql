...
-- strategy_days_per_week 컬럼 매핑 추가
-- =====================================================
...
-- 코멘트 업데이트
COMMENT ON FUNCTION create_plan_group_atomic IS '플랜 그룹과 관련 데이터(콘텐츠, 제외일, 학원일정)를 원자적으로 생성합니다. strategy_days_per_week 컬럼 매핑 추가됨.';
