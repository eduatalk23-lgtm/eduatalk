...
-- plan_exclusions INSERT 제거 (calendar_events로 마이그레이션 완료)
-- ============================================
--
-- 전제:
--   - 코드에서 p_exclusions는 항상 빈 배열 []로 전달됨
--   - 제외일은 RPC 호출 후 calendar_events로 별도 생성됨
--   - plan_exclusions 테이블 DROP 준비
--
...
-- plan_groups, plan_contents, academy_schedules를 하나의 트랜잭션 내에서 생성.
-- 제외일(exclusions)은 calendar_events 기반으로 별도 생성됩니다.
