...
-- 기존 함수의 pg_exception_detail 버그 수정
-- 플랜 그룹과 관련 데이터를 원자적으로 생성
-- =====================================================
...
-- 코멘트 추가
COMMENT ON FUNCTION create_plan_group_atomic IS '플랜 그룹과 관련 데이터(제외일, 학원일정)를 원자적으로 생성합니다.';
