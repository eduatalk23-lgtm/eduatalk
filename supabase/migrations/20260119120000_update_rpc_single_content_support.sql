-- Phase 3: Update create_plan_group_atomic RPC to support single content mode fields
-- This allows plan_groups to store content info directly instead of using plan_contents table
...
DECLARE
  ...
  v_schedule JSONB;
BEGIN
  -- 1. plan_groups 생성 (Phase 3: 단일 콘텐츠 필드 추가)
