...
export type { ExportSection, ReportExportData } from "./report-transform";
export {
  EDGE_TYPE_LABELS,
  AREA_LABELS,
  SECTION_LABELS,
...
// DOCX re-export
export { exportReportAsDocx } from "./report-docx";

// HTML builder re-export
export { buildReportHtml } from "./report-html";
...
import type { ReportExportData } from "./report-transform";
