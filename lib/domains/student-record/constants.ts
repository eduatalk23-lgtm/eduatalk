...
// 교육부 고시 제2022-33호 기반
// 주요 변경: 생활과윤리→현대사회와윤리, 정치와법→정치+법과사회(분리),
//   한국지리/세계지리→세계시민과지리(일반)+한국지리탐구(진로),
//   동아시아사→동아시아역사기행, 미적분→미적분Ⅰ+대수(일반), 과학Ⅰ/Ⅱ→단일명
export const MAJOR_RECOMMENDED_COURSES_2022: Record<string, { general: string[]; career: string[]; fusion?: string[] }> = {
  "법·행정": {
    general: ["확률과 통계", "현대사회와 윤리", "윤리와 사상", "경제", "정치", "법과 사회", "사회와 문화", "한문"],
    career: ["국제 경제", "사회과제 탐구"],
    fusion: ["세계시민과 지리", "사회문제 탐구"],
  },
  "경영·경제": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "세계시민과 지리", "세계사", "경제", "정치", "사회와 문화"],
    career: ["경제수학", "국제 경제", "사회과제 탐구"],
    fusion: ["금융과 경제생활", "창업과 경영"],
  },
  "심리": {
    general: ["확률과 통계", "현대사회와 윤리", "윤리와 사상", "경제", "사회와 문화", "생명과학"],
    career: ["사회과제 탐구"],
    fusion: ["심리학"],
  },
  "사회복지": {
    general: ["확률과 통계", "현대사회와 윤리", "윤리와 사상", "경제", "사회와 문화"],
    career: ["사회과제 탐구"],
    fusion: ["사회문제 탐구"],
  },
  "교육": {
  ...
  "국어": {
    general: ["윤리와 사상", "세계시민과 지리", "사회와 문화", "한문"],
    career: ["주제 탐구 독서", "문학과 영상", "고전과 윤리", "한국지리 탐구"],
  },
  "외국어": {
    general: ["윤리와 사상", "세계시민과 지리", "동아시아 역사 기행", "세계사", "한문"],
    career: ["영미 문학 읽기", "심화 영어"],
  },
  "사학·철학": {
    general: ["확률과 통계", "윤리와 사상", "세계시민과 지리", "세계사", "동아시아 역사 기행", "사회와 문화", "한문"],
    career: ["고전과 윤리", "주제 탐구 독서", "한국지리 탐구"],
    fusion: ["역사로 탐구하는 현대 세계"],
  },
  "언론·홍보": {
    general: ["확률과 통계", "세계시민과 지리", "세계사", "동아시아 역사 기행", "경제", "정치", "사회와 문화"],
    career: ["사회과제 탐구"],
    fusion: ["미디어 콘텐츠와 활용"],
  },
  "정치·외교": {
    general: ["확률과 통계", "현대사회와 윤리", "윤리와 사상", "경제", "정치", "법과 사회", "사회와 문화"],
    career: ["국제 경제", "사회과제 탐구", "국제 관계의 이해"],
    fusion: ["세계시민과 지리"],
  },
  "수리·통계": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "경제", "정보"],
    career: ["기하", "미적분Ⅱ", "수학과제 탐구", "인공지능 수학"],
    fusion: ["실용 통계"],
  },
  "물리·천문": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "물리학", "화학", "생명과학", "지구과학"],
    career: ["기하", "미적분Ⅱ", "수학과제 탐구", "역학과 에너지", "전자기와 양자"],
    fusion: ["과학의 역사와 문화"],
  },
  "생명·바이오": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "물리학", "화학", "생명과학", "현대사회와 윤리"],
  ...
  "컴퓨터·정보": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "물리학", "현대사회와 윤리", "정보"],
    career: ["기하", "인공지능 수학", "수학과제 탐구", "역학과 에너지"],
    fusion: ["정보과학", "인공지능 기초", "데이터 과학"],
  },
  "기계·자동차·로봇": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "물리학", "화학", "정보"],
    career: ["기하", "수학과제 탐구", "인공지능 수학", "역학과 에너지"],
    fusion: ["인공지능 기초", "로봇과 공학세계"],
  },
  "화학·신소재·에너지": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "물리학", "화학", "생명과학"],
    career: ["기하", "화학 반응의 세계", "역학과 에너지"],
    fusion: ["과학의 역사와 문화"],
  },
  "건축·사회시스템": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "세계시민과 지리", "물리학", "화학", "지구과학"],
    career: ["기하", "역학과 에너지", "지구시스템과학", "한국지리 탐구"],
    fusion: ["도시의 미래 탐구"],
  },
  "사회": {
    general: ["확률과 통계", "현대사회와 윤리", "윤리와 사상", "경제", "정치", "법과 사회", "사회와 문화", "세계시민과 지리"],
    career: ["사회과제 탐구", "한국지리 탐구"],
    fusion: ["사회문제 탐구"],
  },
  "전기·전자": {
  ...
  "보건": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "화학", "생명과학", "현대사회와 윤리"],
    career: ["화학 반응의 세계", "세포와 물질대사"],
  },
  "생활과학": {
    general: ["확률과 통계", "화학", "생명과학", "현대사회와 윤리"],
    career: ["화학 반응의 세계", "세포와 물질대사"],
    fusion: ["생활 속의 바이오"],
  },
  "농림": {
    general: ["대수", "미적분Ⅰ", "확률과 통계", "생명과학", "화학", "지구과학"],
...
// ============================================
// 6-b. 전공 → 계열 매핑 (H3: 전공 인식 매칭)
// ============================================

/** target_major → career_field 광역 계열 매핑 */
const MAJOR_TO_CAREER_FIELD: Record<string, string> = {
  // 인문계열
  "법·행정": "인문사회", "경영·경제": "인문사회", "심리": "인문사회",
  "사회복지": "인문사회", "교육": "인문사회", "국어": "인문사회",
  "외국어": "인문사회", "사학·철학": "인문사회", "언론·홍보": "인문사회",
  "정치·외교": "인문사회", "사회": "인문사회",
  // 자연계열
  "수리·통계": "자연과학", "물리·천문": "자연과학",
  "생명·바이오": "자연과학", "화학·신소재·에너지": "자연과학",
  "농림": "자연과학",
  // 의약계열
  "의학·약학": "의약", "보건": "의약", "생활과학": "의약",
  // 공학계열
  "컴퓨터·정보": "공학", "기계·자동차·로봇": "공학",
  "건축·사회시스템": "공학", "전기·전자": "공학",
  // 예체능
  "음악": "예체능", "미술": "예체능", "체육": "예체능",
};

/**
 * target_major(예: "정치·외교") → career_field 광역 계열(예: "인문사회") 추론.
 * 매핑 없으면 null 반환.
 */
export function inferCareerFieldFromMajor(targetMajor: string): string | null {
...
export const PIPELINE_THRESHOLDS = {
  ...
  /** Phase 1 (Level 4): Step A 신뢰도 임계값. 이하이면 모놀리식 fallback */
  STEP_A_CONFIDENCE_MIN: 0.65,
  /** Phase 1 (Level 4): 3-Step 파이프라인 활성화 플래그 */
...
// ============================================
// 7. 교과 학습단계 선수과목 체인 (2015+2022 통합)
// ============================================

/**
 * [선수 과목, 후수 과목] — 선수를 먼저(낮은 학년에) 이수해야 정상.
 * course-plan/recommendation.ts, rubric-matcher.ts 등에서 공통 참조.
 */
