...
import type { PipelineContext, GradeAnalysisContext } from "../pipeline-types";
...
function makeMinimalReportData(
  ...
  weakCompetencyContexts: import("../pipeline-types").CompetencyAnalysisContext[] = [],
): ReportData {
...
describe("buildGuideAnalysisContextFromReport()", () => {
  ...
  it("weakCompetencyContexts가 있으면 그대로 전달된다", () => {
    const weakItems: import("../pipeline-types").CompetencyAnalysisContext[] = [
      { item: "critical_thinking", grade: "B-", reasoning: "논리 비약" },
