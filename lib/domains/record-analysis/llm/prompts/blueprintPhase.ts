...
11. sharedCompetencies는 한국 고등학교 생기부 역량 코드 10종을 사용합니다 (student_record_competency_scores DB 셋과 정합):
    academic_inquiry, academic_attitude, academic_achievement,
    career_course_effort, career_course_achievement, career_exploration,
    community_caring, community_collaboration, community_integrity, community_leadership
  ...
  "targetConvergences": [
    {
      ...
      "sharedCompetencies": ["academic_inquiry", "career_exploration"],
      "confidence": 0.85,
...
// DB 정렬 10 역량 코드 (student_record_competency_scores.competency_item CHECK).
// shadow weaknessFix / blueprint sharedCompetencies / gap-tracker 등 모든 경로 동일 셋 사용.
