...
export async function getGrades(): Promise<Grade[]> {
  ...
  if (error) {
    console.error("[contentMetadata] 학년 조회 실패", error);
    throw new Error(`학년 조회 실패: ${error.message}`);
  }
...
export async function createGrade(
  ...
  if (error) {
    console.error("[contentMetadata] 학년 생성 실패", error);
    throw new Error(`학년 생성 실패: ${error.message}`);
  }
...
export async function updateGrade(
  ...
  if (error) {
    console.error("[contentMetadata] 학년 수정 실패", error);
    throw new Error(`학년 수정 실패: ${error.message}`);
  }
...
export async function deleteGrade(id: string): Promise<void> {
  ...
  if (error) {
    console.error("[contentMetadata] 학년 삭제 실패", error);
    throw new Error(`학년 삭제 실패: ${error.message}`);
  }
}
...
export async function getSemesters(): Promise<Semester[]> {
  ...
  if (error) {
    console.error("[contentMetadata] 학기 조회 실패", error);
    throw new Error(`학기 조회 실패: ${error.message}`);
  }
...
export async function createSemester(
  ...
  if (error) {
    console.error("[contentMetadata] 학기 생성 실패", error);
    throw new Error(`학기 생성 실패: ${error.message}`);
  }
...
export async function updateSemester(
  ...
  if (error) {
    console.error("[contentMetadata] 학기 수정 실패", error);
    throw new Error(`학기 수정 실패: ${error.message}`);
  }
...
export async function deleteSemester(id: string): Promise<void> {
  ...
  if (error) {
    console.error("[contentMetadata] 학기 삭제 실패", error);
    throw new Error(`학기 삭제 실패: ${error.message}`);
  }
}
