...
**특징**:
- 여러 플랜 그룹의 학원 일정을 병합하여 표시
- 동일한 시간대의 학원 일정은 하나만 표시 (중복 제거)
...
### 캘린더 뷰
- 모든 활성 플랜 그룹의 학원 일정을 조회
- 동일 시간대는 하나만 표시하여 UI 깔끔하게 유지
...
3. ✅ 캘린더에는 월요일 9:00-10:00 (1개), 화요일 10:00-11:00 (1개), 수요일 14:00-15:00 (1개) 표시
4. ✅ 중복된 월요일 일정은 하나만 표시
