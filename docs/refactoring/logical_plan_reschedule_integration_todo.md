...
- **파일**: `app/(student)/plan/group/[id]/reschedule/_components/BatchAdjustmentPanel.tsx` (신규)
- **작업**:
  - 일괄 조정 모드 토글 ✅
  - 선택된 콘텐츠 수 표시 ✅
  - 일괄 조정 패널 UI ✅
...
- **작업**:
  - 여러 콘텐츠를 한 번에 교체 ✅ (로직 완료)
  - 교체 매핑 관리 ✅
  - 일괄 교체 미리보기 ✅
  - UI는 향후 추가 가능 (현재는 로직만 완료)
- **위험도**: 🟡 중간
- **의존성**: I5-2 완료
- **상태**: ✅ 완료 (로직 완료, UI는 선택적)
...
| 2025-01-22 | 1.5  | Phase 5 완료 (일괄 조정 기능)           |
| 2025-01-22 | 1.6  | Phase 6 완료 (자동 재조정 제안)         |
| 2025-01-22 | 1.7  | Phase 7 완료 (재조정 히스토리 분석)     |
