...
2. **날짜 타입 표시 개선**: 학습일/복습일을 아이콘+텍스트 형식으로 표시
   ...
   - 변경: 월/일과 같은 줄에 오른쪽에 아이콘 + 텍스트 형식으로 표시 (예: "✏️ 학습일", "🔄 복습일")
   - 학습일/복습일일 때만 표시
   - 레이아웃: 월/일(왼쪽) | 아이콘+학습일(오른쪽) 같은 줄 배치
...
<div className="mb-1.5 flex items-center justify-between">
  ...
  {/* 학습일/복습일일 때 아이콘 + 텍스트 표시 - 같은 줄 오른쪽 */}
...
- **레이아웃 최적화**: 월/일과 날짜 타입 정보를 같은 줄에 배치하여 공간 효율성 향상

## 커밋 정보
- 커밋 해시: `8d1bd49` - "주별 캘린더 날짜 표시를 월/일 형식으로 통일하고 학습일/복습일을 아이콘+텍스트로 표시"
- 커밋 해시: `fa11519` - "주별 캘린더에서 월/일과 아이콘+학습일을 같은 줄에 배치"
