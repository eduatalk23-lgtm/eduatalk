...
- [x] 테스트 가이드 문서 작성
  - [x] 파일명: `docs/rls-policy-phase3-test-guide.md`
  - [x] 테스트 환경 준비 가이드
  - [x] 정상 케이스 테스트 시나리오
  - [x] 에러 케이스 테스트 시나리오
  - [x] 성능 및 보안 검증 가이드
  - [x] 로그 및 모니터링 검증 가이드
- [x] 테스트 결과 문서 템플릿 작성
  - [x] 파일명: `docs/rls-policy-phase3-test-results.md`
  - [x] 테스트 결과 기록 템플릿
  - [x] 검증 체크리스트 포함

#### 산출물

- [x] [테스트 가이드 문서](./rls-policy-phase3-test-guide.md)
- [x] [테스트 결과 문서 템플릿](./rls-policy-phase3-test-results.md)

**참고**: 실제 테스트는 수동으로 수행해야 하며, 테스트 가이드 문서를 참고하여 진행하세요.
...
**테스트 가이드**: [rls-policy-phase3-test-guide.md](./rls-policy-phase3-test-guide.md) 섹션 2 참조
...
- [ ] 보안 검증 (다른 사용자 레코드 생성 시도)
  - [ ] RLS 정책에 의해 차단되는지 확인
  - [ ] 에러 코드 `42501` 확인

**테스트 가이드**: [rls-policy-phase3-test-guide.md](./rls-policy-phase3-test-guide.md) 섹션 3 참조
...
**테스트 가이드**: [rls-policy-phase3-test-guide.md](./rls-policy-phase3-test-guide.md) 섹션 4 참조
...
**테스트 가이드**: [rls-policy-phase3-test-guide.md](./rls-policy-phase3-test-guide.md) 섹션 5 참조
...
- [ ] 테스트 결과 기록
  - [ ] [테스트 결과 문서](./rls-policy-phase3-test-results.md)에 결과 기록
  - [ ] 각 테스트 케이스 결과 입력
  - [ ] 발견된 이슈 및 해결 방법 기록
  - [ ] 성능 및 보안 검증 결과 기록
...
- [x] 작업 시작
- [x] 테스트 가이드 문서 작성 완료 ([rls-policy-phase3-test-guide.md](./rls-policy-phase3-test-guide.md))
- [x] 테스트 결과 문서 템플릿 작성 완료 ([rls-policy-phase3-test-results.md](./rls-policy-phase3-test-results.md))
- [ ] 회원가입 플로우 통합 테스트 완료 (수동 테스트 필요)
- [ ] 에러 케이스 테스트 완료 (수동 테스트 필요)
- [ ] 성능 및 보안 검증 완료 (수동 테스트 필요)
- [ ] 테스트 결과 문서화 완료 (수동 테스트 완료 후)
...
- [테스트 가이드](./rls-policy-phase3-test-guide.md) - Phase 3 통합 테스트 가이드
- [테스트 결과 문서](./rls-policy-phase3-test-results.md) - 테스트 결과 기록 템플릿
...
Phase 3 통합 테스트를 수행하려면 다음 문서를 참고하세요:

1. **[테스트 가이드](./rls-policy-phase3-test-guide.md)**: 상세한 테스트 시나리오 및 검증 방법
2. **[테스트 결과 문서](./rls-policy-phase3-test-results.md)**: 테스트 결과를 기록할 템플릿

### 빠른 시작

1. 테스트 환경 준비 (가이드 섹션 1 참조)
2. 정상 케이스 테스트 (가이드 섹션 2 참조)
   - 학생 회원가입 플로우 테스트
   - 학부모 회원가입 플로우 테스트
3. 에러 케이스 테스트 (가이드 섹션 3 참조)
4. 성능 및 보안 검증 (가이드 섹션 4 참조)
5. 로그 검증 (가이드 섹션 5 참조)
6. 결과 문서화 (테스트 결과 문서에 기록)
