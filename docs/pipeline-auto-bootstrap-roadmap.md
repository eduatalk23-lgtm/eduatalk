...
**상태**: Phase 1~2 구현 완료 (Phase 1: 2026-04-18, Phase 2: 2026-04-18)
...
### Phase 2 — 관측성·정합성 (✅ 완료, 2026-04-18)
**목표**: Bootstrap 을 1급 파이프라인으로 승격

- ✅ `pipelineType="bootstrap"` 신설 (`migrations/20260418100000_pipeline_type_extend_bootstrap.sql`)
...
- ✅ UI: Bootstrap 섹션 (`PipelinePanelApp.tsx`, `BOOTSTRAP_TASK_LABEL_MAP`)
- ✅ **조치 A** 부분 수행: heartbeat UPDATE 메커니즘 정립 (+ 2026-04-18 `touchPipelineHeartbeat` 헬퍼 신설로 draft_analysis/draft_generation chunk 러너에도 확장)
- 실증: xrun-seed-01 Run (2026-04-18 13:40) 에서 `pipeline_type='bootstrap'` row 정상 생성, 3 태스크 completed, 이어지는 blueprint/synthesis 정상 완주
...
| 2026-04-18 | Phase 2 구현 완료. pipelineType='bootstrap' 1급 승격, UI 섹션, cascade, heartbeat. 별도 xrun Run 에서 bootstrap pipeline row 생성·3 태스크 completed 실증. Phase 3 착수. |
