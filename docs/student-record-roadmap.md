> ⚠️ **DEPRECATED — 과거 로드맵 (2026-03-17 기준)**
>
> 본 로드맵의 Phase 1~9.4는 **이미 완료**되었습니다.
> 현재 진행 중인 로드맵은 [`ARCHITECTURE.md` §7](./ARCHITECTURE.md#7-로드맵)을 참조하세요.
>
> 보존 이유: 과거 의사결정 맥락. 분기 정리 시 `docs/archive/`로 이동 예정.
