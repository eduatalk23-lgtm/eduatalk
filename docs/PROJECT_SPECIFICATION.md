> ⚠️ **DEPRECATED — 초기 기획서 (v1.0)**
>
> 이 문서는 **학습 플랜 SaaS** 시절의 기획서입니다.
> 프로젝트는 이후 **생기부 AI 컨설팅 플랫폼**으로 중심축이 이동했습니다.
> - 현재 정체성·아키텍처: [`ARCHITECTURE.md`](./ARCHITECTURE.md)
> - 현재 로드맵: [`ARCHITECTURE.md` §7](./ARCHITECTURE.md#7-로드맵)
>
> 본 문서는 초기 설계 맥락 참고용으로만 보존합니다.
