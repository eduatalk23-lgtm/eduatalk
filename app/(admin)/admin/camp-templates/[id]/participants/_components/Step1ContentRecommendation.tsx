...
import { bulkApplyRecommendedContents } from "@/lib/domains/camp/actions";
import { AVAILABLE_SUBJECTS } from "@/app/(student)/plan/new-group/_components/_features/content-selection/constants";
