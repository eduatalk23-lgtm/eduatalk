...
import { getLectureRecommendationById } from "@/lib/domains/plan/llm/actions/coldStart/persistence";
import { cn } from "@/lib/cn";

export default async function LectureRecommendationDetailPage({
  params,
}: {
  ...
  const lecture = await getLectureRecommendationById(id);
            ...
            <div>
              ...
              {instructorName && (
                <p className="text-lg text-gray-600">
                  {instructorId ? (
                    <Link
                      href={`/admin/master-instructors/${instructorId}`}
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {instructorId && (
              <div className="rounded-xl border bg-white p-6 shadow-sm">
                ...
                <Link
                  href={`/admin/master-instructors/${instructorId}`}
                  className="inline-flex items-center gap-2 rounded-lg bg-indigo-50 px-4 py-3 text-indigo-700 hover:bg-indigo-100 transition"
                >
                  <span className="font-medium">{instructorName}</span>
                  <span className="text-sm text-indigo-500">상세 정보 보기 →</span>
                </Link>
              </div>
            )}
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-xl border bg-gradient-to-br from-indigo-50 to-purple-50 p-6 shadow-sm">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <dt className="text-gray-500">총 시간</dt>
                  <dd className="font-medium text-gray-900">
