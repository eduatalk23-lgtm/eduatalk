  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-900">학년 관리</h2>
        <button
          onClick={() => {
            setIsCreating(true);
            setEditingId(null);
