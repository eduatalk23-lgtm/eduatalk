  ...
  return (
    ...
    >
      ...
      <div className="mt-4 pt-4 border-t border-border">
        <Link
          href={`/admin/students/${studentId}/plans`}
          className="group flex items-center justify-between rounded-lg border border-border bg-gradient-to-r from-indigo-50 to-purple-50 p-4 hover:shadow-md transition-all"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-text-primary">플랜 관리 페이지로 이동</p>
              <p className="text-sm text-text-tertiary">
                플래너 생성, 플랜 그룹 관리, AI 플랜 생성 등 모든 기능
              </p>
            </div>
          </div>
          <ExternalLink className="h-5 w-5 text-text-tertiary group-hover:text-indigo-600" />
        </Link>
      </div>
    </SectionCard>
  );
