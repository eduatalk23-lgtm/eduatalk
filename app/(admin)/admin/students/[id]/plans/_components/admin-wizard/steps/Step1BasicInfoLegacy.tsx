...
/**
 * @deprecated 이 컴포넌트는 레거시 호환성을 위해 유지됩니다.
 * 새 구현에서는 Step1BasicInfo (Context 기반)을 사용하세요.
 */
...
interface Step1BasicInfoLegacyProps {
  periodStart: string;
  periodEnd: string;
  name: string;
 ...
 */
export function Step1BasicInfoLegacy({
  periodStart,
  periodEnd,
  name,
  planPurpose,
