...
export function WeeklyCoachingSection({ coaching }: WeeklyCoachingSectionProps) {
  return (
    <div className="flex flex-col gap-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <h2 className="text-xl font-semibold text-gray-900">이번주 코칭 요약</h2>
      ...
      {coaching.warnings.length > 0 && (
        <div className="flex flex-col gap-2">
          <h3 className="text-sm font-semibold text-gray-700">주의할 점</h3>
          <ul className="flex flex-col gap-2">
      ...
      {coaching.nextWeekGuide.length > 0 && (
        <div className="flex flex-col gap-2">
          <h3 className="text-sm font-semibold text-gray-700">다음주 가이드</h3>
          <ul className="flex flex-col gap-2">
