  ...
  return (
    <div className="p-6 md:p-10">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">시스템 관리 설정</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <div className="mt-1 text-lg font-medium text-gray-900">Super Admin</div>
            </div>
            <div>
        ...
        {/* 시스템 관리 */}
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-xl font-semibold text-gray-900">시스템 관리</h2>
