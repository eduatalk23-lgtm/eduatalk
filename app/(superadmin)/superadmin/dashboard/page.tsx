...
export default async function SuperAdminDashboardPage() {
  ...
  return (
    <div className="p-6 md:p-10 flex flex-col gap-8">
      <h1 className="text-3xl font-bold text-gray-900">Super Admin 대시보드</h1>

      {/* 기관 통계 카드 */}
      <div className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold text-gray-900">기관 통계</h2>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div className="text-sm text-gray-600">기관 추가, 수정, 삭제</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-gray-600">관리자 계정 생성 및 관리</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-gray-600">미인증 사용자 확인 및 처리</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-gray-600">테넌트가 할당되지 않은 사용자 관리</div>
          </Link>
        </div>
      </div>
    </div>
