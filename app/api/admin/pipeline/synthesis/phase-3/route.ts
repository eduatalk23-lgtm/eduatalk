...
import { executeSynthesisPhase3 } from "@/lib/domains/record-analysis/pipeline/pipeline-synthesis-phases";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validationError = validatePhasePrerequisites(ctx, 3, "synthesis");
    if (validationError) {
