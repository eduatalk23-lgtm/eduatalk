...
import { executeSynthesisPhase6 } from "@/lib/domains/student-record/pipeline/pipeline-synthesis-phases";
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ phase: 6, type: "synthesis", completed: true, final: true });
  } catch (error) {
