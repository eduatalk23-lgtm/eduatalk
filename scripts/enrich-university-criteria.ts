...
[핵심] 글로벌 역량과 어학 관련 활동이 차별화 요소. 전공 분야 관련 교과 이수와 탐구 활동 중시`,
  ...
  // ── 서울시립대학교 ──
  // 출처: 2026학년도 서울시립대 학생부종합전형 안내
  {
    universityName: "서울시립대학교",
    admissionName: "학생부종합전형",
    documentEvalDetails: `[서류평가 4대 역량]
■ 학업역량: 교과 성취도(정성평가), 교과 이수의 적절성, 학업에 대한 노력과 성취 추이
■ 진로역량: 전공 적합성, 진로 탐색 활동과 경험, 과목 선택의 적극성
■ 공동체역량: 협업, 소통, 나눔, 배려, 리더십
■ 성실성: 출결, 자기주도적 학습 태도, 규칙 준수

[평가 방식] 서류 100% 일괄합산 (면접 없음). 학생부를 기반으로 4개 역량을 종합 정성평가
[핵심] 서울 소재 공립대 특성상 내신 변별력이 높음 (합격자 평균 2등급대). 서류만으로 선발하므로 학생부 기재 내용의 질이 핵심`,
    evaluationFactors: { "학업역량": 0.35, "진로역량": 0.30, "공동체역량": 0.20, "성실성": 0.15 },
    interviewDetails: null,
  },

  // ── 건국대학교 ──
  // 출처: 2026학년도 건국대학교 수시모집요강 + 학종 가이드
  {
    universityName: "건국대학교",
    admissionName: "KU자기추천",
    documentEvalDetails: `[서류평가 3대 역량]
■ 학업역량: 학업 성취도, 학업 태도와 의지, 탐구력
■ 자기주도성: 경험의 다양성, 리더십, 창의적 문제해결력
■ 전공적합성: 전공 관련 활동과 경험, 전공에 대한 관심과 이해

[평가 방식] 1단계 서류 100% (3배수) → 2단계 서류 60% + 면접 40%
[면접] 서류 확인 면접 10분 내외. 제출 서류 기반 질의응답
[핵심] 면접 비중 40%로 높음. 서류에 기재된 활동의 동기와 과정을 구체적으로 설명할 수 있어야 함`,
    evaluationFactors: { "학업역량": 0.35, "자기주도성": 0.30, "전공적합성": 0.35 },
    interviewDetails: "1단계 서류 100% (3배수) → 2단계 서류 60% + 면접 40%. 서류 확인 면접 10분 내외",
  },
  {
    universityName: "건국대학교",
    admissionName: "KU학교추천",
    documentEvalDetails: `[서류평가 3대 역량]
■ 학업역량: 교과 성취도, 학업 태도와 의지, 교과 이수 적절성
■ 진로역량: 전공 관련 교과 이수 노력, 진로 탐색 활동
■ 공동체역량: 협업, 소통, 나눔, 성실성

[평가 방식] 서류 100% 일괄합산 (면접 없음)
[수능최저] 인문: 국수영탐 중 2개 합 5 / 자연: 국수영탐 중 2개 합 6 (수학 포함)
[핵심] 학교장 추천 필수. 수능최저 있으므로 수능 대비 병행 필요`,
    evaluationFactors: { "학업역량": 0.40, "진로역량": 0.30, "공동체역량": 0.30 },
    interviewDetails: null,
  },

  // ── 동국대학교 ──
  // 출처: 2026학년도 동국대학교 수시모집요강 + 학종 안내
  {
    universityName: "동국대학교",
    admissionName: "Do Dream",
    documentEvalDetails: `[서류평가 3대 역량]
■ 학업역량: 학업 성취도와 학업 노력, 교과 이수의 적절성, 탐구 활동
■ 진로역량: 전공 관련 교과 이수 및 성취, 진로 관련 활동과 경험
■ 공동체역량: 나눔, 협력, 소통, 도덕성, 성실성

[평가 방식] 서류 100% 일괄합산 (면접 없음)
[수능최저] 없음
[핵심] 수능최저 없는 서류 전형. 내신 성적뿐 아니라 세특의 전공 연계 탐구 활동이 중요한 차별화 요소`,
    evaluationFactors: { "학업역량": 0.35, "진로역량": 0.35, "공동체역량": 0.30 },
    interviewDetails: null,
  },
  {
    universityName: "동국대학교",
    admissionName: "Do Dream(면접형)",
    documentEvalDetails: `[서류평가 3대 역량 — Do Dream과 동일 체계]
■ 학업역량, 진로역량, 공동체역량

[평가 방식] 1단계 서류 100% (3배수) → 2단계 서류 60% + 면접 40%
[면접] 서류 기반 면접 10분 내외. 서류 내용 확인 + 인성 평가
[핵심] 면접 40% 비중. 세특에 기재된 탐구 활동의 과정과 결과를 논리적으로 설명할 수 있어야 함`,
    evaluationFactors: { "학업역량": 0.35, "진로역량": 0.35, "공동체역량": 0.30 },
    interviewDetails: "1단계 서류 100% (3배수) → 2단계 서류 60% + 면접 40%. 서류 기반 면접 10분 내외",
  },

  // ── 숙명여자대학교 ──
  // 출처: 2026학년도 숙명여대 수시모집요강 + 학종 가이드
  {
    universityName: "숙명여자대학교",
    admissionName: "숙명인재(서류형)",
    documentEvalDetails: `[서류평가 3대 역량]
■ 학업역량: 학업 성취도, 학업 의지와 태도, 지적 탐구심
■ 성장가능성: 자기주도성, 경험의 다양성, 리더십, 창의성
■ 공동체의식: 나눔과 배려, 소통, 협업, 도덕성

[평가 방식] 서류 100% 일괄합산 (면접 없음). 수능최저 없음
[핵심] 수능최저 없는 서류 전형으로 내신 실질 반영이 높음. 여대 특성상 리더십과 공동체 활동 기여도 중시`,
    evaluationFactors: { "학업역량": 0.40, "성장가능성": 0.30, "공동체의식": 0.30 },
    interviewDetails: null,
  },
  {
    universityName: "숙명여자대학교",
    admissionName: "숙명인재(면접형)",
    documentEvalDetails: `[서류평가 + 면접 종합평가]
■ 학업역량, 성장가능성, 공동체의식 (서류형과 동일 역량)
■ 면접: 인성 + 가치관 + 의사소통 능력 평가

[평가 방식] 1단계 서류 100% (4배수) → 2단계 서류 40% + 면접 60%
[면접] 개별 면접 15분 내외. 제출 서류 기반 확인 + 인성·가치관 질문
[핵심] 면접 60%로 비중이 매우 높음. 서류 내용의 진정성을 면접에서 증명해야 함`,
    evaluationFactors: { "학업역량": 0.35, "성장가능성": 0.30, "공동체의식": 0.35 },
    interviewDetails: "1단계 서류 100% (4배수) → 2단계 서류 40% + 면접 60%. 개별 면접 15분 내외",
  },
];
